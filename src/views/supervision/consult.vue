        ...
        <div class="main-content">
            <div class="filter">
                <Form ref="formFilter" :model="formFilter" inline :label-width="80">
                    ...
                    <FormItem label="咨询事项：">
                        <Select v-model="formFilter.docType" style="width:160px" clearable placeholder="请选择违规事项">
                    ...
                    <FormItem label="咨询日期：">
                        <Row>
                            <Col span="11">
                            <DatePicker type="date" placeholder="请选择开始日期" :editable="false"  style="width:160px;"  v-model="formFilter.startDate"></DatePicker>
                            </Col>
                            <Col span="2" style="text-align: center">&nbsp;</Col>
                            <Col span="11">
                            <DatePicker type="date" placeholder="请选择结束日期" :editable="false"  style="width:160px;"  v-model="formFilter.endDate"></DatePicker>
                            </Col>
                        </Row>
                    ...
                    <FormItem label="咨询渠道：">
                        <Select v-model="formFilter.docType" style="width:160px" clearable placeholder="请选择违规事项">
                            <Option v-for="item in consultWayList" :value="item.value" :key="item.value">{{ item.label }}</Option>
                        </Select>
                    </FormItem>
                    <FormItem label="跟进状态：" class="">
                        <Select v-model="formFilter.docType" style="width:160px" clearable placeholder="请选择跟进状态">
                            <Option v-for="item in followStatusList" :value="item.value" :key="item.value">{{ item.label }}</Option>
                        </Select>
                    </FormItem>
            ...
            <div class="handle-btn">
                ...
                <Button type="primary" @click="handleImport">导出</Button>
                <div class="inline-block">
                    <Button type="primary" class="no-margin-right" @click="isShow=!isShow">批量操作</Button>
                    <ButtonGroup v-show="isShow">
                        <Button type="ghost" class="no-margin-right btn-batch-item">跟进</Button>
                        <Button type="ghost" class="no-margin-right btn-batch-item">转交</Button>
                        <Button type="ghost" class="no-margin-right btn-batch-item">完成</Button>
                    </ButtonGroup>
                </div>
            </div>
            <div class="table">
                <Table border @on-selection-change="handleSelectChange" :columns="isShow?columnsSelect:columns" :data="data"></Table>
            </div>
...
export default {
    ...
    computed: {
        ...
        ...mapState(['followStatusList', 'consultWayList'])
    }
}
</script>
